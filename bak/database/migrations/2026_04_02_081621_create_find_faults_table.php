...
return new class extends Migration
{
    ...
    {
        Schema::create('find_faults', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(\App\Models\Statistic::class)->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->string('right');
    ...
    {
        Schema::dropIfExists('find_faults');
    }
};
